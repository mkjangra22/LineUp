...
function createSupabaseClient() {
  ...
  const SUPABASE_URL = env.VITE_SUPABASE_URL || 'https://wdadebqxntvoealbqyiv.supabase.co';
  const SUPABASE_PUBLISHABLE_KEY = env.VITE_SUPABASE_PUBLISHABLE_KEY || 'sb_publishable_dummy_key_placeholder';

  if (!env.VITE_SUPABASE_PUBLISHABLE_KEY) {
    console.warn('[Supabase] VITE_SUPABASE_PUBLISHABLE_KEY is not set in .env. Please configure your key in .env for live backend functionality.');
  }
